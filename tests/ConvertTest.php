...
test('convert to fluent type', function ($value, $expected): void {
...
test('convert from fluent type', function ($value, $expected): void {
...
test('convert to base 10', function ($number, $from_base, $expected): void {
...
test('convert from base 10', function ($number, $to_base, $expected): void {
